 ...
 * However, this class does not get the special allowlisting granted to CpsScript instances, so
...
public class RuntimeContainerBase extends Script implements Serializable {
    ...
    /* Overriding methods defined in DefaultGroovyMethods
            ...
            is that most of them are not allowlisted, and the other problem is that we want them to
