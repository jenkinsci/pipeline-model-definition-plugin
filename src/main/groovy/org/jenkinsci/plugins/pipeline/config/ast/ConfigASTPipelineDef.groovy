...
import org.jenkinsci.plugins.pipeline.config.model.Root
...
public final class ConfigASTPipelineDef extends ConfigASTElement {
    ConfigASTStages stages
    ConfigASTNotifications notifications
    ConfigASTPostBuild postBuild
    ConfigASTEnvironment environment
    ConfigASTAgent agent
    ConfigASTTools tools

    public ConfigASTPipelineDef(Object sourceLocation) {
